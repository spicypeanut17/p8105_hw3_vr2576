...
ggsave("avg_tmax_janjuly.png", width = 8, height = 6, dpi = 100)
...
densityplot <- ggplot(ny_noaa_hw3, aes(x = tmin, y = tmax)) +  
  ...
  theme_minimal()
densityplot
ggsave("temp_relationship_densityplot.png", width = 8, height = 6, dpi = 100)
...
histogram <- snowfall_data |>
  ...
  theme_minimal()
histogram
ggsave("snowfall_dist_histogram.png", width = 8, height = 6, dpi = 100)
...
violin_plot
ggsave("snowfall_dist_violin.png", width = 8, height = 6, dpi = 100)


# Two-panel plot
(heatmap | violin_plot)
ggsave("q1_two_panel_plot.png", width = 8, height = 6, dpi = 100)


# Three-panel plot 
(heatmap | densityplot / violin_plot)
ggsave("q1_three_panel_plot.png", width = 8, height = 6, dpi = 100)
